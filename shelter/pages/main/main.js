...
const pets = [
  ...
  {
    "name": "Scarlett",
    "img": "../../../shelter/assets/images/pets-scarlett.png",
    "type": "Dog",
...
document.querySelector('.content-section__button').addEventListener('click', function () {
  window.location.href = '../../../shelter/pages/pets/pets.html';
});
...
function getPet(name) {
  return pets.find(obj => obj.name === name);
}
...
openModal.forEach(card => {
  card.addEventListener('click', () => {
    ...
    const inoculations = document.querySelector('#pet-inoculations');
    const diseases = document.querySelector('#pet-diseases');
    const parasites = document.querySelector('#pet-parasites');
    const pet = getPet(`${name.innerHTML}`);
